...
| `projects_filter` | `string` | No | (Optional) Comma-separated list of project keys to filter results by. Narrows within the server's configured JIRA_PROJECTS_FILTER; it cannot widen it or reach projects the server excludes. |
