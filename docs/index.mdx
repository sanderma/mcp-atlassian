...
<CardGroup cols={2}>
  ...
  <Card title="Jira Read/Write Scope" icon="shield-halved" href="/docs/advanced/jira-scope">
    Bound what an agent can see and change with two JQL filters
  </Card>
  <Card title="Markdown ↔ Jira Wiki Markup" icon="code" href="/docs/advanced/markdown-to-jira">
    How rich text is translated on Server/Data Center
  </Card>
</CardGroup>
